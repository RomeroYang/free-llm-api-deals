...
**Dataset generated:** `2026-09-23`<br>
**Status cutoff:** `2026-09-23` (derived from `generated_at`)<br>
...
|---|---|---|---|---|:---:|---|---|
| **Nex AGI Nex-N2.5-Mini (Free Trial)**<br><sub>Agentic coding model exploring codebases and implementing multi-file solutions with 262K context.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI Nex-N2.5-Pro (Free Trial)**<br><sub>Agentic coding model exploring codebases and implementing multi-file solutions with 262K context.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Dots Studio Dots3-Note Preview (Free Trial)**<br><sub>Free preview of lightweight open-weight MoE model with 512K context and multimodal support.</sub> | OpenRouter | `time-limited` | — | 2026-12-31 | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere North Mini Code (Free)**<br><sub>Permanent free agentic coding model from Cohere with 30B total / 3B active parameters.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Google Gemma 4 26B A4B (Free)**<br><sub>Permanent free instruction-tuned MoE model with 25.2B total / 3.8B active parameters and multimodal support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google Gemma 4 31B (Free)**<br><sub>Permanent free 30.7B dense multimodal model with configurable thinking mode and native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI Ling 3.0 Flash Fin (Free)**<br><sub>Permanent free finance-focused model with 262K context and tool calling.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI Ling 3.0 Flash Sante (Free)**<br><sub>Permanent free healthcare-focused model with 262K context and tool calling.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **LiquidAI LFM2.5-2.6B (Free)**<br><sub>Permanent free compact reasoning model for agent workflows and data extraction.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3.5 Content Safety (Free)**<br><sub>Permanent free multimodal content safety model for input/output moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3.5 Lightning (Free)**<br><sub>Permanent free open MoE model with 1M context for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Nano Omni (Free)**<br><sub>Permanent free multimodal perception sub-agent with 30B total / 3B active parameters and 256K context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Super (Free)**<br><sub>Permanent free 120B total / 12B active open hybrid MoE model for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Ultra (Free)**<br><sub>Permanent free frontier reasoning and orchestration model with 550B total / 55B active parameters and 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside Laguna S 2.1 (Free)**<br><sub>Permanent free coding agent model with 118B total / 8B active parameters and 70.2% Terminal-Bench 2.1 score.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside Laguna XS 2.1 (Free)**<br><sub>Permanent free compact coding agent model with 33B total / 3B active parameters.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen Qwen3.8 27B (Free)**<br><sub>Permanent free open-weight vision-language model for coding, workflows, and long-running agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines Inkling (Free)**<br><sub>Permanent free flagship open multimodal MoE for reasoning, coding, and agentic tool-use systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines Inkling Small (Free)**<br><sub>Permanent free open multimodal MoE supporting text, image, and audio with 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai GLM 5.2 (Free)**<br><sub>Permanent free large-scale reasoning model for long-horizon agent workflows and software engineering.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |

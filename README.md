...
**Dataset generated:** `2026-09-25`<br>
**Status cutoff:** `2026-09-25` (derived from `generated_at`)<br>
**Entries:** 59 live, 1 expired
...
|---|---|---|---|---|:---:|---|---|
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding with codebase exploration.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding with visual feedback loop.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free on OpenRouter, 256K context, Cohere's first agentic coding model, 30B-3B MoE.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **DeepSeek: DeepSeek V4 Flash 0731 (free)**<br><sub>Permanently free on OpenRouter, 1M context, positioned for coding, reasoning, and agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Permanent free on OpenRouter, 512K context, lightweight MoE with text and image input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free on OpenRouter, 262K context, 3.8B-25.2B MoE instruction-tuned with multimodal input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free on OpenRouter, 262K context, 30.7B dense multimodal with configurable reasoning and native function-calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Clip Preview (free)**<br><sub>Permanently free on OpenRouter, 1M context, music generation model for 30-second clip generation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Pro Preview (free)**<br><sub>Permanently free on OpenRouter, 1M context, music generation model for high-quality audio output.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent free on OpenRouter, 262K context, specialized for finance and investment domains.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent free on OpenRouter, 262K context, specialized for health and medicine domains.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI Ling 3.0 Flash VL (Free)**<br><sub>Permanent free multimodal model supporting text, image, and video with 262K context and tool calling.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-23 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanent free on OpenRouter, 65K context, suited for agent workflows, data extraction, and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free on OpenRouter, 128K context, 4B guardrail model for LLM/VLM input and response moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free on OpenRouter, 1M context, 3B-30B MoE for high-throughput agentic tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free on OpenRouter, 256K context, 30B-3B multimodal perception sub-agent for enterprise systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free on OpenRouter, 262K context, 12B-120B hybrid Mamba-Transformer MoE for multi-agent systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free on OpenRouter, 1M context, 55B-550B MoE frontier reasoning with hybrid Transformer-Mamba.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, coding agent model scoring 70.2% on Terminal-Bench 2.1.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, 33B-3B lightweight coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanent free on OpenRouter, 262K context, optimized for coding with multimodal support.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Space Bunny Alpha (free)**<br><sub>Permanent free on OpenRouter, 1M context, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free on OpenRouter, 1M+ context, 41B-975B MoE, designed for coding and agentic tool-use.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free on OpenRouter, 1M+ context, 12B-276B MoE, multimodal with text, image, audio.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanent free on OpenRouter, 32K context, long-horizon agent workflows and project-level engineering.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |

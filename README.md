...
| **Dots Studio: Dots 3 Note Preview (free)**<br><sub>Time-limited OpenRouter free preview through September 30 with 512000 context.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent OpenRouter free tier coding model with 256000 context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent OpenRouter free tier instruction-tuned MoE model with 262144 context and multimodal support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent OpenRouter free tier dense multimodal instruction-tuned model with 262144 context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Clip Preview (free)**<br><sub>Permanent OpenRouter free tier music clip generation model with 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Pro Preview (free)**<br><sub>Permanent OpenRouter free tier music generation model with 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent OpenRouter free tier of finance-focused model with 262144 context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent OpenRouter free tier of healthcare-focused model with 262144 context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent OpenRouter free tier with 262144 context, text+image+video input support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Liquid AI: LFM 2.5 2.6B (free)**<br><sub>Permanent OpenRouter free tier with 65536 context, optimized for agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent OpenRouter free tier with 262144 context, designed for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent OpenRouter free tier with 262144 context, designed for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent OpenRouter free tier content moderation model with 128000 context.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent OpenRouter free tier with 1M context, optimized for agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent OpenRouter free tier multimodal model with 256000 context supporting text, image, audio, and video.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent OpenRouter free tier hybrid MoE model with 262144 context for multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent OpenRouter free tier frontier reasoning model with 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent OpenRouter free tier coding agent model with 262144 context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent OpenRouter free tier compact coding agent model with 262144 context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent OpenRouter free tier large multimodal model with 1M context for coding and reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent OpenRouter free tier multimodal model with 1M context supporting text, image, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |

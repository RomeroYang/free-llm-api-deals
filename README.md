...
| **Dots Studio: Dots3-Note Preview (free trial)**<br><sub>Free tier on OpenRouter until Sept 30, 2026, with 512K context and image support.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free tier on OpenRouter, agentic coding model with 256K context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, multimodal input (text, image, video).</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, multimodal input and function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free tier on OpenRouter, agentic model for coding and multi-file exploration.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free tier on OpenRouter, agentic model for coding and multi-file exploration.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free tier on OpenRouter with 1M context for agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free tier on OpenRouter with 256K context, multimodal input (text, image, audio, video).</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free tier on OpenRouter with 262K context for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free tier on OpenRouter with 1M context for frontier reasoning and orchestration.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **OpenRouter: Free Models Router (free)**<br><sub>Permanent free tier on OpenRouter routing to available free models with 200K context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free tier on OpenRouter for coding agent workloads with 262K context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free tier on OpenRouter for coding agent workloads with 262K context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, designed for coding and agentic reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, multimodal input (text, image, audio).</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |

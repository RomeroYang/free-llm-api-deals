...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Limited-time free preview on OpenRouter (through 2026-09-30) with 512K context, text and image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free tier on OpenRouter with 256K context, optimized for agentic coding.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, multimodal (text, image, video) MoE model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, multimodal (text, image, video) with native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, multimodal (text, image, video) input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, optimized for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, optimized for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free tier on OpenRouter with 256K context, multimodal (text, image, audio, video) perception model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, hybrid MoE model optimized for multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, latest coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free tier on OpenRouter with 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, multimodal (text, image, audio), designed for coding and agentic systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free tier on OpenRouter with 1M context, multimodal (text, image, audio) input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |

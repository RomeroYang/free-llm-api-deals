...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview on OpenRouter until Sept 30 2026, 512K context.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free on OpenRouter, 256K context, agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free on OpenRouter, 262K context, multimodal MoE model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free on OpenRouter, 262K context, multimodal with function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent free on OpenRouter, 262K context, finance focused.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent free on OpenRouter, 262K context, health and medicine focused.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free on OpenRouter, 262K context, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanent free on OpenRouter, 65K context, reasoning and agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free on OpenRouter, 128K context, content moderation guardrail.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free on OpenRouter, 1M context, high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free on OpenRouter, 256K context, multimodal perception and reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free on OpenRouter, 262K context, hybrid MoE for multi-agent apps.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free on OpenRouter, 1M context, frontier reasoning and orchestration.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, compact coding agent.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free on OpenRouter, 1M context, coding and agentic systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal (text/image/audio)</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |

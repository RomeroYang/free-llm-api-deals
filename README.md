...
**Dataset generated:** `2026-09-17`<br>
**Status cutoff:** `2026-09-17` (derived from `generated_at`)<br>
**Entries:** 57 live, 0 expired
...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free trial on OpenRouter until 2026-09-30 with 512K context, text and image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter with 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter with 262K context, supports text, image, and video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter with 262K context, supports text, image, and video input, native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter with 262K context, specialized for finance and investment.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter with 262K context, specialized for healthcare and medicine.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanently free on OpenRouter with 262K context, text, image, and video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter with 65K context, suited for agent workflows and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanently free on OpenRouter with 262K context, designed for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanently free on OpenRouter with 262K context, designed for agentic coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter with 128K context, content moderation and guardrail model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter with 1M context, suited for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter with 256K context, supports text, image, audio, and video input.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter with 262K context, hybrid MoE architecture for multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter with 1M context, frontier-reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter with 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter with 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter with 1M context, general-purpose reasoning, coding, and agentic workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter with 1M context, supports text, image, and audio input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanently free on OpenRouter with 32K context, large-scale reasoning for long-horizon agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-17 | [Source](<https://openrouter.ai/api/v1/models>) |

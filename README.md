...
**Dataset generated:** `2026-09-16`<br>
**Status cutoff:** `2026-09-16` (derived from `generated_at`)<br>
**Entries:** 56 live, 0 expired
...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview on OpenRouter through September 30, 2026 with 512K context.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter with 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter with 262K context, instruction-tuned multimodal MoE from Google.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter with 262K context, 30.7B dense multimodal model from Google with reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Clip Preview**<br><sub>Permanently free on OpenRouter with 1M context, Google's music generation model for 30-second audio clips.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Pro Preview**<br><sub>Permanently free on OpenRouter with 1M context, Google's music generation model producing full-length songs.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter with 262K context, specialized for finance and investment.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter with 262K context, specialized for health and medicine.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanently free on OpenRouter with 262K context, text, image, and video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter with 64K context, compact reasoning model for RAG and agents.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanently free on OpenRouter with 262K context, designed for agentic coding with visual feedback.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanently free on OpenRouter with 262K context, agentic coding model with visual feedback loop.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter with 128K context, guardrail model for content moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter with 1M context, MoE model for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter with 256K context, multimodal perception sub-agent supporting text, image, video, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter with 262K context, 120B-parameter hybrid MoE for multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter with 1M context, frontier reasoning MoE with 550B parameters.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter with 262K context, 118B-parameter coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter with 262K context, 33B-parameter coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter with 1M context, designed for reasoning, coding, and agentic systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter with 1M context, multimodal MoE supporting text, image, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanently free on OpenRouter with 32K context, large-scale reasoning model for agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-16 | [Source](<https://openrouter.ai/api/v1/models>) |

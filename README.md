...
**Dataset generated:** `2026-09-20`<br>
**Status cutoff:** `2026-09-20` (derived from `generated_at`)<br>
...
|---|---|---|---|---|:---:|---|---|
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview on OpenRouter through September 30, 512K context, text+image to text.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter, 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter, 262K context, instruction-tuned mixture-of-experts vision model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter, 262K context, dense multimodal model with function calling and reasoning mode.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **InclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter, 262K context, specialized finance mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **InclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter, 262K context, specialized healthcare mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **InclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanently free on OpenRouter, 262K context, text+image+video to text.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Liquid AI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter, 64K context, compact reasoning model for agent workflows and extraction.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanently free on OpenRouter, 262K context, agentic model for codebase exploration and multi-file implementation.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanently free on OpenRouter, 262K context, agentic model for codebase exploration and multi-file implementation.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter, 128K context, specialized content safety guardrail model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter, 1M context, suited for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter, 256K context, multimodal perception sub-agent for enterprise agent systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter, 262K context, hybrid MoE model for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter, 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanently free on OpenRouter, 262K context, vision model suited for coding, workflows, and long-running agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter, 1M context, multimodal model for reasoning, coding, and agentic systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter, 1M context, multimodal mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanently free on OpenRouter, 32K context, large-scale reasoning model for long-horizon agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-20 | [Source](<https://openrouter.ai/api/v1/models>) |

...
**Dataset generated:** `2026-09-24`<br>
**Status cutoff:** `2026-09-24` (derived from `generated_at`)<br>
...
|---|---|---|---|---|:---:|---|---|
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Free on OpenRouter with 262K context, optimized for agentic coding workflows.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Free on OpenRouter with 262K context, optimized for agentic coding workflows.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview on OpenRouter with 512K context and multimodal support.</sub> | OpenRouter | `time-limited` | — | 2026-12-31 | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Space Bunny Alpha (free)**<br><sub>Permanently free on OpenRouter with 1M context window and multimodal input support.</sub> | OpenRouter | `time-limited` | — | 2098-12-31 | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter, Cohere's first agentic coding model with efficient sparse MoE.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter, efficient Google MoE model with 262K context and multimodal support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter, Google's 31B dense multimodal model with configurable reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter, finance-focused mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter, health and medicine-focused mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter, compact reasoning model for agent workflows and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter, compact multimodal guardrail model for content moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter with 1M context, optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter, multimodal sub-agent model supporting text, image, video, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter, 120B hybrid MoE model with 12B active parameters for complex multi-agent systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter, frontier reasoning and orchestration MoE model with 1M context.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter, specialized coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter, efficient compact coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanently free on OpenRouter with strong coding, professional workflows, and multimodal capabilities.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter with 1M context, designed for coding, reasoning, and tool-use systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter with 1M context, multimodal input and tool-calling support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanently free on OpenRouter, large-scale reasoning model for long-horizon agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-24 | [Source](<https://openrouter.ai/api/v1/models>) |

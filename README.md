...
**Dataset generated:** `2026-09-26`<br>
**Status cutoff:** `2026-09-26` (derived from `generated_at`)<br>
**Entries:** 57 live, 3 expired
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter, 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Permanently free on OpenRouter, 512K context, lightweight open mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter, 262K context, instruction-tuned mixture-of-experts from Google DeepMind.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter, 262K context, Google DeepMind's dense multimodal model with configurable reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Clip Preview (free)**<br><sub>Permanently free on OpenRouter, 1M context window, Google's music generation model for short audio clips.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Pro Preview (free)**<br><sub>Permanently free on OpenRouter, 1M context window, Google's music generation model for full-length songs.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter, 262K context, finance-focused mixture-of-experts.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter, 262K context, health and medicine-focused mixture-of-experts.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter, 65K context, compact reasoning model for agent workflows and data extraction.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter, 128K context, compact multimodal guardrail model for content moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter, 1M context window, open mixture-of-experts for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter, 256K context, open multimodal model for perception and context sub-agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter, 262K context, open hybrid mixture-of-experts model for multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter, 1M context window, open frontier-reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262K context, latest coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262K context, lightweight coding agent model in the 33B-A3B category.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanently free on OpenRouter, 262K context, multimodal vision-language model suited for coding and agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Space Bunny Alpha (free)**<br><sub>Permanently free on OpenRouter, 1M context window, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter, 1M context window, open multimodal mixture-of-experts for reasoning, coding, and agentic systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter, 1M context window, open multimodal mixture-of-experts.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-26 | [Source](<https://openrouter.ai/api/v1/models>) |
...
|---|---|---|---|---|
| **Nex AGI: Nex-N2.5-Mini (free)** | OpenRouter | `time-limited` | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)** | OpenRouter | `time-limited` | 2026-09-25 | [Source](<https://openrouter.ai/api/v1/models>) |

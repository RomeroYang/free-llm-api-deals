...
**Dataset generated:** `2026-08-31T00:00:00Z`<br>
**Status cutoff:** `2026-08-31` (derived from `generated_at`)<br>
...
| **Gemini 2.5 Flash-Lite (free)**<br><sub>Ultra-lightweight free model, standard input and output are free (source: ai.google.dev/gemini-api/docs/pricing)</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/pricing>) |
| **Gemini 2.5 Pro (free)**<br><sub>Gemini API free tier, standard input and output are free (source: ai.google.dev/gemini-api/docs/pricing)</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/pricing>) |
| **Gemini 3 Flash Preview (free tier)**<br><sub>Google AI Studio free tier, 1M input / 65K output, multimodal, preview track (source: ai.google.dev/gemini-api/docs/pricing)</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/models/gemini-3-flash-preview>) |
| **Gemini 3.1 Flash-Lite (free tier)**<br><sub>Google AI Studio free tier, 1M input / 65K output, multimodal, cheaper than 3.5-Lite</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-lite>) |
| **Gemini 3.5 Flash (free tier)**<br><sub>Google AI Studio free tier, 1M input / 65K output, multimodal, supports function calling and structured output</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash>) |
| **Gemini 3.5 Flash-Lite (free tier)**<br><sub>Google AI Studio free tier, 1M input / 65K output, multimodal, cheapest in the 3.x family</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite>) |
| **Gemini 3.7 Flash (free tier)**<br><sub>Google AI Studio free tier, 1M input / 65K output, multimodal (text/image/video/audio/PDF), supports function calling, structured output, thinking and grounding</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | Yes | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/models/gemini-3.7-flash>) |
| **Gemini Embedding 2 (free)**<br><sub>Fully multimodal embedding model, available on the free tier</sub> | Google AI Studio (Gemini API) | `free-tier` | — | No announced end date | No | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/pricing>) |
| **Gemini Google Maps grounding tool (free)**<br><sub>Flash gets 500 RPD; unavailable for Pro</sub> | Google AI Studio (Gemini API) | `free-tier` | 500 RPD | No announced end date | No | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/pricing>) |
| **Gemini Google Search grounding tool (free)**<br><sub>Flash and Flash-Lite share 500 RPD on the free tier; unavailable for Pro</sub> | Google AI Studio (Gemini API) | `free-tier` | 500 RPD | No announced end date | No | 2026-08-31 | [Source](<https://ai.google.dev/gemini-api/docs/pricing>) |

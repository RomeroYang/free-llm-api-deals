...
**Dataset generated:** `2026-09-12`<br>
**Status cutoff:** `2026-09-12` (derived from `generated_at`)<br>
...
| **Dots Studio Dots3-Note Preview (free)**<br><sub>Free preview until 2026-09-30, 512K context, text+image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere North Mini Code (free)**<br><sub>Permanent free tier, 256K context, agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google Gemma 4 26B A4B (free)**<br><sub>Permanent free tier, 262K context, instruction-tuned MoE, text+image+video.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google Gemma 4 31B (free)**<br><sub>Permanent free tier, 262K context, text+image, native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI Ling 3.0 Flash Fin (free)**<br><sub>Permanent free tier, 262K context, finance and investment specialist model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI Ling 3.0 Flash Sante (free)**<br><sub>Permanent free tier, 262K context, health and medicine specialist model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI Ling 3.0 Flash VL (free)**<br><sub>Permanent free tier, 262K context, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI LFM2.5-2.6B (free)**<br><sub>Permanent free tier, 64K context, compact reasoning model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI Nex-N2.5-Mini (free)**<br><sub>Permanent free tier, 262K context, agentic model for coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI Nex-N2.5-Pro (free)**<br><sub>Permanent free tier, 262K context, agentic model for coding workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free tier, 128K context, multimodal content safety model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3.5 Lightning (free)**<br><sub>Permanent free tier, 1M context, high-throughput agentic model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Nano Omni (free)**<br><sub>Permanent free tier, 256K context, multimodal perception sub-agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Super (free)**<br><sub>Permanent free tier, 262K context, hybrid MoE model for complex multi-agent systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA Nemotron 3 Ultra (free)**<br><sub>Permanent free tier, 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside Laguna S 2.1 (free)**<br><sub>Permanent free tier, 262K context, coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside Laguna XS 2.1 (free)**<br><sub>Permanent free tier, 262K context, lightweight coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines Inkling (free)**<br><sub>Permanent free tier, 1M context, multimodal coding and reasoning model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines Inkling Small (free)**<br><sub>Permanent free tier, 1M context, text+image+audio input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |

...
**Dataset generated:** `2026-09-22`<br>
**Status cutoff:** `2026-09-22` (derived from `generated_at`)<br>
...
|---|---|---|---|---|:---:|---|---|
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Free through Sept 25 on OpenRouter, 262144 context, text+image input, agentic coding.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Free through Sept 25 on OpenRouter, 262144 context, text+image input, agentic coding.</sub> | OpenRouter | `time-limited` | — | 2026-09-25 | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free through Sept 30 on OpenRouter, 512000 context, text+image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanently free on OpenRouter, 256000 context, Cohere's agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanently free on OpenRouter, 262144 context, instruction-tuned multimodal MoE model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanently free on OpenRouter, 262144 context, native function calling and configurable reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanently free on OpenRouter, 262144 context, specialized for finance.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanently free on OpenRouter, 262144 context, specialized for health and medicine.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanently free on OpenRouter, 262144 context, text+image+video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanently free on OpenRouter, 65536 context, compact reasoning and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanently free on OpenRouter, 128000 context, multimodal content moderation and guardrails.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanently free on OpenRouter, 1M context, optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanently free on OpenRouter, 256000 context, multimodal perception (text, image, audio, video).</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanently free on OpenRouter, 262144 context, hybrid MoE for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanently free on OpenRouter, 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262144 context, optimized for coding agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanently free on OpenRouter, 262144 context, optimized for coding agent tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanently free on OpenRouter, 262144 context, text+image+video, coding and long-context tasks.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanently free on OpenRouter, 1M context, multimodal, designed for coding and agentic workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanently free on OpenRouter, 1M context, multimodal with text, image, and audio input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanently free on OpenRouter, 32768 context, supports long-horizon agent workflows and software engineering.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-22 | [Source](<https://openrouter.ai/api/v1/models>) |

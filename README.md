...
**Dataset generated:** `2026-09-14`<br>
**Status cutoff:** `2026-09-14` (derived from `generated_at`)<br>
**Entries:** 55 live, 0 expired
...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free on OpenRouter through 2026-09-30, 512K context, text and image input with text output.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free on OpenRouter, 256K context, Cohere's first agentic coding model with sparse mixture-of-experts.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free on OpenRouter, 262K context, instruction-tuned MoE with multimodal (text, image, video) support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free on OpenRouter, 262K context, dense multimodal (text, image, video) with native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google Lyria 3 Clip Preview (free)**<br><sub>Permanent free tier, 1M context, 30-second music clip generation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google Lyria 3 Pro Preview (free)**<br><sub>Permanent free tier, 1M context, music generation from text and image.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-12 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent free on OpenRouter, 262K context, finance-focused mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent free on OpenRouter, 262K context, health and medicine-focused mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free on OpenRouter, 262K context, multimodal (text, image, video) input with text output.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanent free on OpenRouter, 65K context, compact reasoning model suited for agent workflows and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding within visual feedback loop.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding within visual feedback loop.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free on OpenRouter, 128K context, multimodal guardrail model for input/output moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free on OpenRouter, 1M context, open MoE model optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free on OpenRouter, 256K context, multimodal (text, image, audio, video) perception and context sub-agent.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free on OpenRouter, 262K context, hybrid MoE model optimized for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free on OpenRouter, 1M context, frontier-class reasoning and orchestration with hybrid MoE architecture.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, coding agent model with 70.2% Terminal-Bench 2.1 score.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, efficient coding agent model with 33B parameter base.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free on OpenRouter, 1M context, large multimodal (text, image, audio) mixture-of-experts for reasoning and coding.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal (text, image, audio) mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-14 | [Source](<https://openrouter.ai/api/v1/models>) |

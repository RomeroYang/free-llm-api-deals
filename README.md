...
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview until September 30, 2026 on OpenRouter, 512K context, text+image support.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free on OpenRouter, 256K context, agentic coding model with 3B active parameters.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free on OpenRouter, 262K context, multimodal instruction-tuned MoE model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free on OpenRouter, 262K context, dense multimodal with configurable reasoning.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Clip Preview (free)**<br><sub>Permanent free on OpenRouter, 1M context, generate 30-second music clips from text and images.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Lyria 3 Pro Preview (free)**<br><sub>Permanent free on OpenRouter, 1M context, generate full-length songs from text and images.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent free on OpenRouter, 262K context, specialized for finance and investment.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent free on OpenRouter, 262K context, specialized for health and medicine.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free on OpenRouter, 262K context, text+image+video to text.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanent free on OpenRouter, 65K context, compact reasoning for RAG and extraction.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding with visual feedback.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding model with visual feedback.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free on OpenRouter, 128K context, multimodal content moderation and guardrail model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free on OpenRouter, 1M context, optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free on OpenRouter, 256K context, multimodal text+image+audio+video perception agent.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free on OpenRouter, 262K context, 120B hybrid MoE for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free on OpenRouter, 1M context, frontier-reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, coding agent model with 70.2% Terminal-Bench score.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, compact 33B coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal for reasoning, coding, and agent systems.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal text+image+audio support.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-11 | [Source](<https://openrouter.ai/api/v1/models>) |

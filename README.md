...
**Dataset generated:** `2026-09-15`<br>
**Status cutoff:** `2026-09-15` (derived from `generated_at`)<br>
...
| **Dots Studio: Dots3-Note Preview**<br><sub>Free preview on OpenRouter until September 30, 2026, with 512K context and text+image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code**<br><sub>Permanently free on OpenRouter with 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 26B A4B**<br><sub>Permanently free on OpenRouter with 262K context, Google's multimodal mixture-of-experts model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B**<br><sub>Permanently free on OpenRouter with 262K context, Google's multimodal instruction-tuned model with native function calling.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI: Ling 3.0 Flash Fin**<br><sub>Permanently free on OpenRouter with 262K context, specialized for finance and investment applications.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante**<br><sub>Permanently free on OpenRouter with 262K context, specialized for healthcare and medical applications.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL**<br><sub>Permanently free on OpenRouter with 262K context, text, image, and video input.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B**<br><sub>Permanently free on OpenRouter with 65K context, optimized for agent workflows and long-context processing.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini**<br><sub>Permanently free on OpenRouter with 262K context, built for agentic coding and goal-driven outcomes.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro**<br><sub>Permanently free on OpenRouter with 262K context, professional-grade agentic coding capabilities.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety**<br><sub>Permanently free on OpenRouter with 128K context, specialized guardrail model for content moderation.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning**<br><sub>Permanently free on OpenRouter with 1M context, optimized for high-throughput agentic workloads.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni**<br><sub>Permanently free on OpenRouter with 256K context, multimodal perception with text, image, video, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super**<br><sub>Permanently free on OpenRouter with 262K context, hybrid Mamba-Transformer MoE for complex multi-agent applications.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra**<br><sub>Permanently free on OpenRouter with 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1**<br><sub>Permanently free on OpenRouter with 262K context, latest coding agent model from Poolside.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1**<br><sub>Permanently free on OpenRouter with 262K context, lightweight coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling**<br><sub>Permanently free on OpenRouter with 1M context, multimodal reasoning, coding, and agentic capabilities.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small**<br><sub>Permanently free on OpenRouter with 1M context, multimodal input with text, image, and audio.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-15 | [Source](<https://openrouter.ai/api/v1/models>) |

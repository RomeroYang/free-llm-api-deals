...
**Dataset generated:** `2026-09-21`<br>
**Status cutoff:** `2026-09-21` (derived from `generated_at`)<br>
...
|---|---|---|---|---|:---:|---|---|
| **Dots Studio: Dots3-Note Preview (free)**<br><sub>Free preview through Sept 30, 2026 on OpenRouter, 512K context, text+image input.</sub> | OpenRouter | `time-limited` | — | 2026-09-30 | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Cohere: North Mini Code (free)**<br><sub>Permanent free on OpenRouter, 256K context, Cohere's first agentic coding model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **Google: Gemma 4 26B A4B (free)**<br><sub>Permanent free on OpenRouter, 262K context, text+image+video, efficient MoE with 3.8B active parameters.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Google: Gemma 4 31B (free)**<br><sub>Permanent free on OpenRouter, 262K context, dense multimodal model with configurable thinking mode.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
...
| **inclusionAI: Ling 3.0 Flash Fin (free)**<br><sub>Permanent free on OpenRouter, 262K context, finance-focused specialist model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash Sante (free)**<br><sub>Permanent free on OpenRouter, 262K context, health and medicine-focused specialist model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **inclusionAI: Ling 3.0 Flash VL (free)**<br><sub>Permanent free on OpenRouter, 262K context, text+image+video input with tool calling.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **LiquidAI: LFM2.5-2.6B (free)**<br><sub>Permanent free on OpenRouter, 65K context, compact reasoning for agent workflows and RAG.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Mini (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding with visual feedback loop.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Nex AGI: Nex-N2.5-Pro (free)**<br><sub>Permanent free on OpenRouter, 262K context, agentic coding with visual feedback loop.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Content Safety (free)**<br><sub>Permanent free on OpenRouter, 128K context, multimodal content moderation guardrail model.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3.5 Lightning (free)**<br><sub>Permanent free on OpenRouter, 1M context, high-throughput agentic model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Nano Omni (free)**<br><sub>Permanent free on OpenRouter, 256K context, multimodal perception and context sub-agent.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Super (free)**<br><sub>Permanent free on OpenRouter, 262K context, 120B total with 12B active parameters, hybrid MoE model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **NVIDIA: Nemotron 3 Ultra (free)**<br><sub>Permanent free on OpenRouter, 1M context, frontier reasoning and orchestration model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna S 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, latest coding agent model with 70.2% on Terminal-Bench 2.1.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Poolside: Laguna XS 2.1 (free)**<br><sub>Permanent free on OpenRouter, 262K context, compact 33B-A3B coding agent model.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Qwen: Qwen3.8 27B (free)**<br><sub>Permanent free on OpenRouter, 262K context, text+image+video, suited for coding and agent workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal MoE for reasoning, coding, and agentic workflows.</sub> | OpenRouter | `always-free` | — | No announced end date | Yes | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Thinking Machines: Inkling Small (free)**<br><sub>Permanent free on OpenRouter, 1M context, multimodal MoE with text+image+audio.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
| **Z.ai: GLM 5.2 (free)**<br><sub>Permanent free on OpenRouter, 32K context, large-scale reasoning for software engineering agents.</sub> | OpenRouter | `always-free` | — | No announced end date | No | 2026-09-21 | [Source](<https://openrouter.ai/api/v1/models>) |
